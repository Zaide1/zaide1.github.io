  ...
  <div class="full-width-section">
      <div class="info-box" id="featured">
        ...
        <div class="image-container">
          <!-- Item 1 -->
          <div class="square-image">
            <a href="items_buy.html">
              <img src="assets/img/outer.png" alt="Logo" width="250px" height="250px">
            </a>
          </div>
          <!-- Item 2 -->
          <div class="square-image">
            <a href="items_buy.html">
              <img src="assets/img/bottoms.png" alt="Logo" width="250px" height="250px">
            </a>
          </div>
          <!-- Item 3 -->
          <div class="square-image">
            <a href="items_buy.html">
              <img src="assets/img/accessories.png" alt="Logo" width="250px" height="250px">
            </a>
          </div>
          <!-- Item 4 -->
          <div class="square-image">
            <a href="items_buy.html">
              <img src="assets/img/shoes.png" alt="Logo" width="250px" height="250px">
            </a>
          </div>
        </div>
      </div>
    ...
    <div class="full-width-section">
      <div class="info-box" id="secondRow">
       <div class="image-container">
          <!-- Item 5 -->
          <div class="square-image">
            <a href="items_buy.html">
              <img src="assets/img/item5.png" alt="Logo" width="250px" height="250px">
            </a>
          </div>
          <!-- Item 6 -->
          <div class="square-image">
            <a href="items_buy.html">
              <img src="assets/img/item6.png" alt="Logo" width="250px" height="250px">
            </a>
          </div>
          <!-- Item 7 -->
          <div class="square-image">
            <a href="items_buy.html">
              <img src="assets/img/item7.png" alt="Logo" width="250px" height="250px">
            </a>
          </div>
          <!-- Item 8 -->
          <div class="square-image">
            <a href="items_buy.html">
              <img src="assets/img/item8.png" alt="Logo" width="250px" height="250px">
            </a>
          </div>
        </div>
      </div>
